'use strict';const e=require('express');const r=e.Router();const knex=require('../knex'); const jwt=require('jsonwebtoken').sign;
const b=require('bcrypt').compareSync;const bam=require('boom').create(400, 'Bad email or password');
